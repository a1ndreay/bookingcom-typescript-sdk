...
The REST API documentation can be found on [docs.booking.com.com](https://docs.booking.com.com). The full API of this library can be found in [api.md](api.md).
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/booking.com-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install booking.com`
...
const response = await client.hotels.list().asResponse();
...
1. Via the `BOOKING_COM_LOG` environment variable
...
const client = new BookingCom({
  logger: logger.child({ name: 'BookingCom' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/booking.com-typescript/issues) with questions, bugs, or suggestions.
