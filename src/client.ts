...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['BOOKING_COM_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['BOOKING_COM_LOG'] or 'warn' if it isn't set.
   */
...
export class BookingCom {
   ...
   * @param {string} [opts.baseURL=process.env['BOOKING_COM_BASE_URL'] ?? https://dn0j3gz6uqdsusj.ru/api/v1] - Override the default base URL for the API.
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('BOOKING_COM_LOG'), "process.env['BOOKING_COM_LOG']", this) ??
      defaultLogLevel;
  ...
  static BookingCom = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static BookingComError = Errors.BookingComError;
